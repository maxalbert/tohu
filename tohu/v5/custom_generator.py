...
from .namespace import TohuNamespace
...
class CustomGenerator(TohuBaseGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        namespace = TohuNamespace()
        for name, g in self.field_gen_templates.items():
            namespace.add_generator_with_dependencies(g, name=name)

        self.namespace = namespace.spawn()
        self.field_gens_named = namespace.named_generators
        self.field_gens_all = namespace.generators
        self.__dict__.update(self.namespace.named_generators)
    ...
    def _spawn(self, spawn_mapping):
        # TODO: should we be passing on spawn_mapping?!
